<x-guest-layout>
    ...
    <section class="px-2 py-32 bg-white dark:bg-gray-800 dark:text-white md:px-0">
    ...
    <section class="py-20 bg-gray-50 dark:bg-gray-800 dark:text-white">
            ...
            <div class="flex flex-wrap items-center -mx-3">
                <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div class="w-full lg:max-w-md">
                        ...
                        <p class="mb-4 font-medium tracking-tight text-gray-400 dark:text-white xl:mb-6">Lorem ipsum
                            dolor sit amet
                            consectetur
                        ...
                        <ul>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                <svg class="w-8 h-8 text-gray-500 dark:text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z">
                                    </path>
                                </svg>
                                <span class="font-medium text-gray-500 dark:text-white">Faster Processing and
                                    Delivery</span>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-gray-500 dark:text-white"
                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <span class="font-medium text-gray-500 dark:text-white">Easy Payments</span>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                <svg class="w-8 h-8 text-gray-500 dark:text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="font-medium text-gray-500 dark:text-white">100% Protection and Security for
                                    Your App</span>
                            </li>
                        </ul>
                    </div>
    ...
    <section class="mt-8 bg-white dark:bg-gray-800 dark:text-white">
                ...
                <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg bg-white ">
                    ...
                    <div class="px-6 py-4">
                        ...
                        <h4 class="mb-3 text-xl font-semibold tracking-tight text-green-600 uppercase">salmon fish 1
                            seafood</h4>
                        <p class="leading-normal text-gray-600 dark:text-gray-800">Lorem ipsum dolor, sit amet cons
                            ectetur
                            adipis icing
                            elit.</p>
                    </div>
